...
const UiPagesOrganisationDevicesForm = ({ onCloseRightDrawer, toggleLoader}) => {
  ...
  try {
    ...
    console.warn('OrganisationProvider not available in UiPagesOrganisationDevicesForm context')
  }
  ...
  const fields = [
    { label: dictionary.Name, value: 'name' },
    { label: dictionary.Description, value: 'description' },
    { label: dictionary.Reference, value: 'reference' },
  ...
  const handleCancel  = async() => {
    toggleLoader(true)
    await handleChangePageReference("organisation devices")
    resetForm()
    toggleLoader(false)
    onCloseRightDrawer()
  }
...
UiPagesOrganisationDevicesForm.propTypes = {
  onCloseRightDrawer: PropTypes.func.isRequired,
  toggleLoader: PropTypes.func.isRequired
}

export default UiPagesOrganisationDevicesForm