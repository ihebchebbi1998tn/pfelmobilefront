...
const UiPagesCustomerDevicesForm = ({ onCloseRightDrawer, toggleLoader}) => {
  ...
  try {
    ...
    console.warn('OrganisationProvider not available in UiPagesCustomerDevicesForm context')
  }
  ...
  const fields = [
    { label: dictionary.Name, value: 'device.name' },
    { label: dictionary.Description, value: 'device.description' },
    { label: dictionary.SerialNumber, value: 'serialNumber' },
    { label: dictionary.UserName, value: 'userName' },
    { label: dictionary.OrganisationName, value: 'device.organizationName' },
    { label: dictionary.Image, value: 'device.imageUrl' }
  ]
  ...
  const handleCancel  = async() => {
    toggleLoader(true)
    await handleChangePageReference("customer devices")
    resetForm()
    toggleLoader(false)
    onCloseRightDrawer()
  }
...
UiPagesCustomerDevicesForm.propTypes = {
  onCloseRightDrawer: PropTypes.func.isRequired,
  toggleLoader: PropTypes.func.isRequired
}

export default UiPagesCustomerDevicesForm