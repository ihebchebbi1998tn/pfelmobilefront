...
const stepsTutorial = [
        { target: '.stepserviceCharges', content: dictionary.HereYoucanPuttheServiceFees },
        { target: '.stepSignature', content: dictionary.hereYoucanPutYourSignature},
      ]
 return (
  <Box>
    <CustomSnackbar
        ...
        <Box sx={{ width: { xs: '350px', sm: '450px', md: '650px', lg: '950px' } }}>
            ...
            {mode==="InProgress" && 
                ...
                >
                    ...
                    <label style={{ color: '#a3a3a3' }} className={'stepSignature'}>
